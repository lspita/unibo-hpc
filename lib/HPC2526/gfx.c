...
void gfx_open( int width, int height, const char *title )
{
    ...
    visual = DefaultVisual(gfx_display,0);
    ...
    blackColor = BlackPixel(gfx_display, DefaultScreen(gfx_display));
    whiteColor = WhitePixel(gfx_display, DefaultScreen(gfx_display));
