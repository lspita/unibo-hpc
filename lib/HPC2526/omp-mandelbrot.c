 ...
 *
 * Copyright (C) 2019, 2020, 2024, 2025 by Moreno Marzolla <https://www.moreno.marzolla.name/>
 *
 ...
 *
 * With the "runtime" scheduling clause, you can select the schedule and
 * chunksize at rumtime, e.g.,
 *
...
const int MAXIT = 10000;  /* A large value to make the program slower */
