 ...
 *
 * Copyright (C) 2018--2021 by Moreno Marzolla <https://www.moreno.marzolla.name/>
 *
 ...
 * require that the matrix size is multiple of SCL_DEFAULT_WG_SIZE2D.
 *
 * Compile with:
...
int main( int argc, char* argv[] )
{
    ...
    const sclDim grid = DIM2(roundup(N, SCL_DEFAULT_WG_SIZE2D), roundup(N, SCL_DEFAULT_WG_SIZE2D));
