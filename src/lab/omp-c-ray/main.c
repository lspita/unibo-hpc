 ...
 * ---------------------------------------------------------------------------
 * Usage:
 *   compile:  gcc -std=c99 -Wall -Wpedantic -fopenmp -O2 -o omp-c-ray
 * omp-c-ray.c -lm
 *
...
- [sphfract.small.in](sphfract.small.in) and [sphfract.big.in](sphfract.big.in)
(generated by [gen-sphfract.c](gen-sphfract.c))
...
const double ERR_MARGIN =
    1e-6; /* an arbitrary error margin to avoid surface acne */
