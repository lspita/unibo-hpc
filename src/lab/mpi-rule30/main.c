...
"Parallelization of the Rule 30 CA.")
...
![Figure 5: Using `MPI_Sendrecv()` to exchange ghost
cells.](mpi-rule30-fig5.svg)
...
#define ASCENDING_ORDER_TAG 0
#define DESCENDING_ORDER_TAG 1
