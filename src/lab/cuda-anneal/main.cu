...
![Figure 1: Computation of the new state of the central cell of a block of size
$3 \times 3$.](cuda-anneal1.svg)
...
src="https://www.youtube-nocookie.com/embed/TSHWSjICCxs" title="YouTube video
...
To compile with shared memory:
        ...
        nvcc --ptxas-options=-v -DUSE_SHARED cuda-anneal.cu -o
cuda-anneal-shared
